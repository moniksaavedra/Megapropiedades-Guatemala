<?php if ( WPERECCP()->front->listing_provider->get_average_rate( get_the_ID() ) ) { ?>
	...
	<div class="rating-overview">
		<div class="rating-overview-box">
			...
			<span class="rating-overview-box-percent"><?php _e( 'out of 5.0', 'resido' ); ?></span>
		...
		<div class="rating-bars">
			...
			if ( $property_width ) {
				...
				<div class="rating-bars-item">
					<span class="rating-bars-name"><?php _e( 'Property', 'resido' ); ?></span>
			...
			if ( $value_for_money_width ) {
				?>
				<div class="rating-bars-item">
					<span class="rating-bars-name"><?php _e( 'Value for Money', 'resido' ); ?></span>
					<span class="rating-bars-inner">
			...
			if ( $location_width ) {
				?>
				<div class="rating-bars-item">
					<span class="rating-bars-name"><?php _e( 'Location', 'resido' ); ?></span>
					<span class="rating-bars-inner">
			...
			if ( $agent_support_width ) {
				?>
				<div class="rating-bars-item">
					<span class="rating-bars-name"><?php _e( 'Support', 'resido' ); ?></span>
					<span class="rating-bars-inner">
	...
	echo esc_html__( 'Not yet Rated.', 'resido' );
}
