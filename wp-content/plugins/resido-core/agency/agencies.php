						...
						<div class="agents-grid">
							<div class="agents-grid-wrap">
								...
								<div class="fr-grid-deatil">
									...
									<?php if ( get_post_meta( get_the_ID(), $prefix . 'agency_email', true ) != '' ) { ?>
									<div class="fr-grid-deatil-flex-right">
										<div class="agent-email"><a href="mailto:<?php listing_meta_field( $prefix . 'agency_email' ); ?>"><i class="ti-email"></i></a></div>
									</div>
									<?php } ?>
								</div>
							</div>
							<div class="fr-grid-info">
								<ul>
									<?php
									if ( get_post_meta( get_the_ID(), $prefix . 'agency_cell', true ) != '' ) {
										?>
										<li><strong><?php echo esc_html__( 'Call: ', 'resido-core' ); ?></strong><?php listing_meta_field( $prefix . 'agency_cell' ); ?></li>
									<?php } ?>
								</ul>
							</div>
							<div class="fr-grid-footer">
								<?php
								if ( get_post_meta( get_the_ID(), $prefix . 'agency_address', true ) != '' ) {
									?>
									<div class="fr-grid-footer-flex">
										<span class="fr-position"><i class="lni-map-marker"></i><?php listing_meta_field( $prefix . 'agency_address' ); ?></span>
									</div>
								<?php } ?>
