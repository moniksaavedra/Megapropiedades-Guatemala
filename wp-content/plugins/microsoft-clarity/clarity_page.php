...
function setup_clarity_notice__info() {
	...
	if(empty($clarity_project_id_option) && $pageQP !== "microsoft-clarity" && current_user_can("edit_posts")) {
        echo
...
/**
* Add callback triggered wwhen a new message is received
...
function edit_clarity_project_id() {
    ...
    $user_must_be_admin = $_POST['user_must_be_admin'];
    if ($user_must_be_admin && !current_user_can('manage_options') ) {
        die(
            json_encode(
                array(
                    'success' => false,
