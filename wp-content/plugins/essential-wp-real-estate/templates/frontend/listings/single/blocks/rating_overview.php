		...
		<div class="rating-bars">
			...
			if ( $property_width ) {
				...
				<div class="rating-bars-item">
					<span class="rating-bars-name"><?php _e( 'Property', 'essential-wp-real-estate' ); ?></span>
			...
			if ( $value_for_money_width ) {
				?>
				<div class="rating-bars-item">
					<span class="rating-bars-name"><?php _e( 'Value for Money', 'essential-wp-real-estate' ); ?></span>
					<span class="rating-bars-inner">
			...
			if ( $location_width ) {
				?>
				<div class="rating-bars-item">
					<span class="rating-bars-name"><?php _e( 'Location', 'essential-wp-real-estate' ); ?></span>
					<span class="rating-bars-inner">
			...
			if ( $agent_support_width ) {
				?>
				<div class="rating-bars-item">
					<span class="rating-bars-name"><?php _e( 'Support', 'essential-wp-real-estate' ); ?></span>
					<span class="rating-bars-inner">
