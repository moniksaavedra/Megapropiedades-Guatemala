			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-6 form-group">
						...
						<input required type="text" name="username" id="username" class="input form-control" value=""/>
					</div>
					<div class="col-md-6 form-group">
						<label for="email"><?php esc_html_e( 'E-mail', 'essential-wp-real-estate' ); ?></label>
						<input required type="text" name="email" id="email" class="input form-control" value=""/>
					</div>
					<div class="col-md-6 form-group">
						<label for="password"><?php esc_html_e( 'Password', 'essential-wp-real-estate' ); ?></label>
						<input required type="password" name="password" id="password" class="input form-control" value="" />
					</div>
					<div class="col-md-6 form-group">
						<label for="conf_password"><?php esc_html_e( 'Confirm Password', 'essential-wp-real-estate' ); ?></label>
						<input required type="password" name="conf_password" id="conf_password" class="input form-control" value=""/>
					</div>
						...
						<div class="col-lg-12 col-md-12">
							<div class="submit-page add">
								<form action="<?php echo esc_url($current_url);?>" method="post" id="listing-submit-form" class="listing-submit-form" enctype="multipart/form-data">
									...
									echo '</div>';
									echo apply_filters( 'cl_add_listing_form_after_filter', '' );
									?>
									<div class="form-group">
										<?php
										wp_nonce_field( 'listing-add-listing', 'submit-listing' );
